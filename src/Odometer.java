...
public class Odometer implements TimerListener {
	...
	public void timedOut() {
		...
		dDH[0] = (leftTacho*HardwareInfo.leftRadius + rightTacho* HardwareInfo.rightRadius)*Math.PI/360;
		dDH[1] = (leftTacho*HardwareInfo.leftRadius - rightTacho* HardwareInfo.rightRadius)/HardwareInfo.width;
 		dDH[0] -= oldDH[0];
		dDH[1] -= oldDH[1];
