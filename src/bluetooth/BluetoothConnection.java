...
/**
 * This class initiates a bluetooth connection, waits for the data and then
...
public class BluetoothConnection {
	...
	/**
	 * Waits for connection from BT server indefinitely. Once connected, gets
	 * the transmission and closes the BT connection.
	 */
	...
	public void printTransmission() {
		try {
			...
			LCD.drawString(
					"(" + trans.greenZone[0] + "," + trans.greenZone[1] + ","
							+ trans.greenZone[2] + "," + trans.greenZone[3]
							+ ")", 0, 4);
			LCD.drawString("Red Zone: ", 0, 5);
			LCD.drawString("(" + trans.redZone[0] + "," + trans.redZone[1]
					+ "," + trans.redZone[2] + "," + trans.redZone[3] + ")", 0,
					6);
